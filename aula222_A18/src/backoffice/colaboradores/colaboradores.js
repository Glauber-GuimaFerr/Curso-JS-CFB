...
btn_pesquisar.addEventListener('click', (evt) => {
    ...
    if(f_pesq.value != ''){
        ...
        const config = {
            titulo: "Alerta",
            texto: "Preencha o campo de pesquisa! Digite o nome ou ID do colaborador.",
            cor: "#008",
            tipo: "ok",
            ok: () => {},
            sim: () => {},
...
const carregarTodosColabs = () => {
    const endpoint_todoscolaboradores = `${sv}/todaspessoas`
...
const criarLinha = (e) => {
    ...
    img_editar.addEventListener('click', (evt) => {
        ...
        .then(res => {
            ...
            f_tipoColab.value = res[0].n_tipopessoa_pessoa
...
btn_gravarPopup.addEventListener('click', (evt) => {
    ...
    const dados = {
        ...
        n_tipopessoa_pessoa: f_tipoColab.value,
    ...
    .then(res => {
        if(res.status == 200){
            if(modojanela == 'n'){
                ...
                const config = {
                    titulo: "OK",
                    texto: "Alterações de colaborador salvas!",
                    cor: "#008",
                    tipo: "ok",
                    ok: () => {},
                    sim: () => {},
