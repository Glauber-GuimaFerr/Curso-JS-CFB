            ...
            .then(res => {
                ...
                if(res.status == 200){
                    ...
                    .then(r => {
                        ...
                        const dados = {
                            n_pessoa_token: r[0].n_pessoa_pessoa,
                        ...
                        sessionStorage.setItem('n_pessoa_pessoa', r[0].n_pessoa_pessoa)
                        sessionStorage.setItem('s_nome_pessoa', r[0].s_nome_pessoa)
                        sessionStorage.setItem('n_tipopessoa_pessoa', r[0].n_tipopessoa_pessoa)
