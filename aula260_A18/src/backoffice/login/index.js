            ...
            .then(res => {
                ...
                if(res.status == 200){
                    ...
                    .then(rs => {
                        ...
                        .then(r => {
                            if(r.status == 200){
                                const endpointArmazenarToken = `${sv}/sessaotoken/${rs[0].n_pessoa_pessoa}`
                                fetch(endpointArmazenarToken)
                                .then(s => s.json())
                                .then(s => {
                                    sessionStorage.setItem('n_token_token', s[0].n_token_token)
                                    sessionStorage.setItem('s_desc_token', s[0].s_desc_token)
