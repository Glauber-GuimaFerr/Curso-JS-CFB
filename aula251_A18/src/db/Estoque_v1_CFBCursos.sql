...
ALTER TABLE `usuario` ADD FOREIGN KEY (`n_tipousuario_usuario`) REFERENCES `tipousuario` (`n_tipousuario_tipousuario`);

ALTER TABLE `telefone` ADD FOREIGN KEY (`n_usuario_telefone`) REFERENCES `usuario` (`n_usuario_usuario`);