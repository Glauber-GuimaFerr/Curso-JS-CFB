...
btn_gravarPopup.addEventListener('click', (evt) => {
    ...
    if(modojanela == 'n'){
        endpoint_novoXeditarColab = 'http://localhost:3000/novocolab'
        ...
        endpoint_novoXeditarColab = `http://localhost:3000/editarcolab/${evt.target.dataset.idcolab}`
        fetch(endpoint_novoXeditarColab)
        .then()
    }
})
