...
app.post('/entradatoken', (req, res) => {
  ...
  const query1 = `INSERT INTO token (n_token_token, n_pessoa_token, s_desc_token, s_validade_token) VALUES (NULL, ?, ?, ?)`;
  ...
  connection.query(query1, values, (error, results1) => {
    ...
    const query2 = `SELECT n_token_token, s_desc_token FROM token WHERE n_token_token = ?`;
